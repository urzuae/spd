...
if ($db->sql_numrows($result) < 1)
{
	die("<html><head><script>alert('Esta distribuidora no tiene vendedores, no se pudo asignar.');location.href='index.php?_module=$_module&_op=contacto';</script></head></html>");//regresar
}
