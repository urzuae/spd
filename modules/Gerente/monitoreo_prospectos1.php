...
{ //while de uid
	...
	, UNIX_TIMESTAMP(c.fecha_cita),
	  ...
	  if ($db->sql_numrows($r2)) //ver si hay, si no dejar "colapsado"
	  {
		...
		$tabla_campanas .=
	"<table style=\"text-align: left; width: 100%;\" border=\"0\" cellpadding=\"2\" cellspacing=\"2\"> <tbody> 
		<tr style=\"cursor:pointer\" onclick=\"var v=document.getElementById('bloque_$uid_$campana_id');	var i=document.getElementById('img_$uid_$campana_id');	if(v.style.display=='none'){v.style.display='block';i.src='img/less.gif'}else{ v.style.display='none';i.src='img/more.gif'}\">
		 <th><img src=\"img/pixel.gif\" width=\"15px\"><img src=\"img/less.gif\" id=\"img_$uid_$campana_id\"> $name</th>
		</tr>
	</tbody>
	</table>
	<div id=\"bloque_$uid_$campana_id\" style=\"display:block;\">";
    ...
    $nombres = array();  
		...
		$counter = 0;
	    while (list($llamada_id, $origen_id, $contacto_id, $nombre, $apellido_paterno, $apellido_materno, $fecha_cita, $fecha_cita_timestamp, $tel_casa, $tel_oficina, $tel_movil, $tel_otro, $llamda_timestamp, $status_id) = $db->sql_fetchrow($r2))
	    {
      ...
      case "nombre2": $array_para_ordenar = &$nombres2;
		...
		$tabla_campanas .= "<table class=\"width100\">"
	                  ."<thead>"
					  ."<tr>"
	                  ."<td style=\"width:180px;\"><az href=\"index.php?_module=$_module&_op=$_op&uid=$uid&campana_id=$campana_id&orderby=origen_id\" style=\"color:white;\">Campaña</az></td>"
					  ."<td style=\"width:360px;\"><az href=\"index.php?_module=$_module&_op=$_op&uid=$uid&campana_id=$campana_id&orderby=nombre\" style=\"color:white;\">Nombre</az></td>"
// 					  ."<td><az href=\"index.php?_module=$_module&_op=$_op&uid=$uid&campana_id=$campana_id&orderby=tel\" style=\"color:white;\">Teléfono</az></td>"
           ."<td style=\"width:360px;\><az href=\"index.php?_module=$_module&_op=$_op&uid=$uid&campana_id=$campana_id&orderby=nombre2\" style=\"color:white;\">Vendedor</az></td>"
					  ."<td style=\"width:50px;\"><az href=\"index.php?_module=$_module&_op=$_op&uid=$uid&campana_id=$campana_id&orderby=ultimo_contacto\" style=\"color:white;\">Espera</az></td>"
					  ."<td style=\"width:180px;\"><az href=\"index.php?_module=$_module&_op=$_op&uid=$uid&campana_id=$campana_id&orderby=primer_contacto\" style=\"color:white;\">Primer contacto</az></td>"
					  ."<td style=\"width:180px;\"><az href=\"index.php?_module=$_module&_op=$_op&uid=$uid&campana_id=$campana_id&orderby=ultimo_contacto\" style=\"color:white;\">Último contacto</az></td>"
					  ."<td style=\"width:180px;\"><az href=\"index.php?_module=$_module&_op=$_op&uid=$uid&campana_id=$campana_id&orderby=fecha_cita\" style=\"color:white;\">Compromiso</az></td>"
					  ."<td style=\"width:180px;\"><az href=\"index.php?_module=$_module&_op=$_op&uid=$uid&campana_id=$campana_id&orderby=fecha_cita\" style=\"color:white;\">Retraso</az></td>"
