...
global $db,$contacto_id,$modelo_id,$version_id,$transmision_id,$timestamp,$chasis,$fecha_ini,$fecha_fin,$fuente_id;
...
if( $num > 0)
{
    ...
    $buffer="<input type='hidden' name='contacto_id' id='contacto_id' value='".$c."'>
             ...
             <tr>
             <td colspan='2' align='center'> Actualizaci&oacute;n del producto vendido</td>
              </tr>
            <tr>
            ...
            <tr>
             <td align='Left'>Producto:</td><td>".$unidades[$modelo_id]."</td>
            </tr>
            <tr>
             <td align='Left'>No. Serie (".$chasis."):</td><td><input type='text' size='15' name='".$tmp_name_chasis."' id='".$tmp_name_chasis."' value='".$chasis."' maxlength='17'></td>
             </tr>
            <tr>
