...
$sql = "SELECT DISTINCT(cuotas_impagadas_original) FROM crm_contactos WHERE gid!='0' ORDER BY cuotas_impagadas_original";
...
//   else 
  $ci_where = " AND c.cuotas_impagadas_original='$ci'";
