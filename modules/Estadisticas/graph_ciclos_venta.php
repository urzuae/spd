...
$modelos = array();
$sql = "SELECT right(c.campana_id,1) as id, count(cl.contacto_id) FROM crm_campanas as c, crm_campanas_llamadas as cl where c.campana_id = cl.campana_id group by right(campana_id,1)";
